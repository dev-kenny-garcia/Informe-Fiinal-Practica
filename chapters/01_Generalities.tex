\chapter{Generalidades de la Empresa}\label{cp:inteligencia-artificial}

\section{Perfil de la Organización}\label{sec:concepto-ramas-IA}
El termino \gls{ia}, a pesar que no posea una definición única y aceptada por todos, la mayor parte de los 
...
\section{Estructura del Departamento de TI}\label{sec:departamento-ti}
\gls{ti}
